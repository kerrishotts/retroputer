...
const KEYBOARD_MAP = [
    ...
    [ ["Backquote",    "`", "~", 0xFF,    0,  0], 
      ["Digit1",       "1", "!", 0xE4,    0, 0x1C], 
      ["Digit2",       "2", "@", 0xE5,    0, 0x1D], 
      ["Digit3",       "3", "#", 0xFB,    0, 0x1E],      
      ["Digit4",       "4", "$", 0xF0,    0, 0x1F], 
      ["Digit5",       "5", "%", 0xF1,    0,  0], 
      ["Digit6",       "6", "^", 0xF2,    0,  0], 
      ["Digit7",       "7", "&", 0xF3,    0,  0], 
      ["Digit8",       "8", "*", 0xF4,    0,  0], 
      ["Digit9",       "9", "(", 0xF5,    0,  0], 
      ["Digit0",       "0", ")", 0xF6,    0, 0x1B], 
      ["Minus",        "-", "_", 0xED,    0,  0],       
      ["Equal",        "=", "+", 0xEB,    0,  0], 
    ...
    [ ["Tab",          TAB, TAB,    0,    0,  0], 
      ...
      ["KeyP",         "p", "P", 0xB2,    0, "P".charCodeAt(0) - 64], 
      ["BracketLeft",  "[", "{", 0xEC,    0,  0], 
      ["BracketRight", "]", "}", 0xEA,    0,  0], 
      ["Backslash",   "\\", "|", 0xEF,    0,  0], 
      ["F3",            F3,  F3,   F3,   F3, F3], 
      ["F4",            F4,  F4,   F4,   F4, F4]],
    [ ["CapsLock",       0,   0,    0,    0,  0], 
      ...
      ["KeyK",         "k", "K", 0xDB,    0, "K".charCodeAt(0) - 64], 
