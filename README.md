...
| `06 70-77`       |`........ 00000110 01110reg ########`| IN reg, port                 |`....OCNZ`| reg := data from port#
...
| `07 80-BF`       |`00000111 10mmmxys ######## ########`| LDD A(L) [DB]                |`....OCNZ`| scale of 1 = AL; 2 = A
...
| `40-7F`          |`........ 01mmmxys ######## ########`| LDS A(L) [SB]                |`....OCNZ`| scale of 1 = AL; 2 = A
