...
32 PRINT AT 20,0; CHR$(27);"18";CHR$(18);CHRS$ GR,X; CHR$(27);"23";CHR$(18);CHR$(SH); CHRS$ RD, W; CHR$(SH); CHR$(27);"18";CHR$(18);CHRS$ GR, RT;
...
115 SC=SC+1
120 GOTO 30
200 PRINT AT 20, 10;CHR$(27);"23";CHR$(18);"*** CRASH ***"
